                    ...
                    <div class="">
                        <table class="table tablesorter " id="">
                            <thead class=" text-primary">
                                ...
                                <th scope="col"><?php echo e(__('Dob')); ?></th>
...
<?php echo $__env->make('layouts.app', ['page' => __('User Management'), 'pageSlug' => 'users', 'section' => 'users'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\Inventory-Management\resources\views/users/index.blade.php ENDPATH**/ ?>