                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Edit Production Entry</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('production.update', $production)); ?>" autocomplete="off">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group<?php echo e($errors->has('date') ? ' has-danger' : ''); ?>">
                                        ...
                                        <input type="date" name="date" id="input-date" class="form-control form-control-alternative" placeholder="Date" value="<?php echo e(old('date', $production->date)); ?>" required>
                                        <?php echo $__env->make('alerts.feedback', ['field' => 'date'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                                     <input type="hidden" name="item_code" id="item_code" value="<?php echo e(old('item_code', $production->item_code)); ?>">
                                     <input type="hidden" name="product_category_id" id="product_category_id" value="<?php echo e(old('product_category_id', $production->product_category_id)); ?>">
                                <div class="form-group<?php echo e($errors->has('item_code') ? ' has-danger' : ''); ?>">
                                        ...
                                        <select name="product_id" id="input-product_id" class="form-select form-control-alternative<?php echo e($errors->has('product_id') ? ' is-invalid' : ''); ?>" required autofocus>
                                            ...
                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($product['id'] == old('document') or $product['id'] == $production->product_id): ?>
                                ...
                                <div class="row"> 
                                   <div class="col-6">
                                        <div class="form-group<?php echo e($errors->has('item_name') ? ' has-danger' : ''); ?>">
                                            ...
                                            <input type="text" name="item_name" id="input-name" class="form-control form-control-alternative<?php echo e($errors->has('item_name') ? ' is-invalid' : ''); ?>" placeholder="Item Name" value="<?php echo e(old('item_name', $production->item_name)); ?>" readonly="true">
                                   ...
                                   <div class="col-6">                                    
                                          <div class="form-group<?php echo e($errors->has('item_quantity') ? ' has-danger' : ''); ?>">
                                                ...
                                                <input type="number" name="item_quantity" id="input-quantity" class="form-control form-control-alternative" placeholder="Quantity" value="<?php echo e(old('item_quantity',$production->item_quantity)); ?>" required readonly="true">
                                ...
                                <div class="row">          
                                        <div class="col-6">                                    
                                            <div class="form-group">
                                                ...
                                                <span id="category" class="form-control" type="box"><?php echo e($production->category->name); ?></span> 
                                            </div>
                                        </div> 
                                        <div class="col-6">                                    
                                            <div class="form-group<?php echo e($errors->has('production') ? ' has-danger' : ''); ?>">
                                                <label class="form-control-label" for="input-stock">Per Hour Production</label>
                                                  ...
                                                  <input type="number" name="item_per_hour" id="item_per_hour" class="form-control form-control-alternative" placeholder="Item Per Hour (in Amount)" value="<?php echo e(old('item_per_hour', $production->item_per_hour)); ?>" required readonly="true">
                                ...
                                <div class="form-group<?php echo e($errors->has('no_of_hours') ? ' has-danger' : ''); ?>">
                                        ...
                                        <input type="number" name="no_of_hours" id="input-no_of_hours" class="form-control form-control-alternative" placeholder="Number of Hours" value="<?php echo e(old('no_of_hours',$production->no_of_hours)); ?>" required>
                                ...
                                <div class="form-group">
                                        ...
                                        <span id="input-production" class="form-control" type="box"><?php echo e($production->item_per_hour * $production->no_of_hours); ?></span>
                                </div> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['page' => 'Edit Product', 'pageSlug' => 'production', 'section' => 'production'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\Inventory-Management\resources\views/inventory/productions/edit.blade.php ENDPATH**/ ?>