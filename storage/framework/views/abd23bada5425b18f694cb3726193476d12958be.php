                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Register Sale Return/Debit</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('salesreturn.store')); ?>" autocomplete="off">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group<?php echo e($errors->has('ref_no') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="ref_no" id="input-ref_no" class="form-control form-control-alternative<?php echo e($errors->has('ref_no') ? ' is-invalid' : ''); ?>" placeholder="Reference Number" value="<?php echo e(old('ref_no')); ?>" required>
...
<?php $__env->stopPush(); ?> -->
<?php echo $__env->make('layouts.app', ['page' => 'Return Sale', 'pageSlug' => 'salesreturn-create', 'section' => 'transactions'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\Inventory-Management\resources\views/sales/returns/create.blade.php ENDPATH**/ ?>