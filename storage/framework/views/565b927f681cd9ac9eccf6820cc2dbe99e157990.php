                        ...
                        <form method="post" action="<?php echo e(route('products.store')); ?>" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                 <div class="form-group<?php echo e($errors->has('item_code') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="item_code" id="input-item_code" class="form-control form-control-alternative" placeholder="Item Code" value="<?php echo e(old('item_code')); ?>" required>
                                ...
                                <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" placeholder="Item Name" value="<?php echo e(old('name')); ?>" required autofocus>
                                ...
                                <div class="row">                           
                                    <div class="col-3"> 
                                        <div class="form-group<?php echo e($errors->has('purchase_price') ? ' has-danger' : ''); ?>">
                                            ...
                                            <input type="number" name="purchase_price" id="input-purchase_price" class="form-control form-control-alternative" placeholder="Purchase Price" value="<?php echo e(old('purchase_price')); ?>" required>
 ...
 -->                                </div>
                                    <div class="col-3">                                    
                                        <div class="form-group<?php echo e($errors->has('price') ? ' has-danger' : ''); ?>">
                                            <label class="form-control-label" for="input-price">Sale Price</label>
                                    ...
                                    <div class="col-3">                                    
                                        <div class="form-group<?php echo e($errors->has('quantity') ? ' has-danger' : ''); ?>">
                                            ...
                                            <input type="number" name="quantity" id="input-quantity" class="form-control form-control-alternative" placeholder="Quantity" value="<?php echo e(old('quantity')); ?>" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['page' => 'New Product', 'pageSlug' => 'products', 'section' => 'inventory'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\Inventory-Management\resources\views/inventory/products/create.blade.php ENDPATH**/ ?>